...
For Each ws In Worksheets
   ...
   ws.Range("K2:K" & LastRow).NumberFormat = "0.00%"
    ...
    'get ticker name for largest increase in percentage
    ...
    'get ticker name for largest decrease in percentage
    For q = 2 To LastRowOut
    If (ws.Cells(q, 11).Value = ws.Cells(3, 17).Value) Then
